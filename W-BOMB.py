...
def update():
    ...
    os.system("cd .. && rm -rf  W-BOMB && git clone https://github.com/MrWiKi9/W-BOMB.git")
    ...
    os.system("cd .. && cd W-BOMB  && python W-BOMB.py")
...
\033[1;97m ____      ____  _   ___  ____    _   

\033[1;32m|_  _|    |_  _|(_) |_  ||_  _|  (_)
